(() => {
  const BioDataComponent = () => {
    ...
    })), group === "family" ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "subsection-title" }, copy.familySiblingsTitle), /* @__PURE__ */ React.createElement("div", { className: "section-item-list section-item-list-compact" }, familySiblings.map(([label, value], idx) => /* @__PURE__ */ React.createElement("div", { className: "sub-detail-row section-card-item", key: idx }, /* @__PURE__ */ React.createElement("div", { className: "detail-label sibling-label" }, /* @__PURE__ */ React.createElement("span", { className: "detail-label-icon" }, /* @__PURE__ */ React.createElement("i", { className: siblingDetailIconClass, "aria-hidden": "true" })), /* @__PURE__ */ React.createElement("span", null, renderTextWithLtrNumbers(label))), /* @__PURE__ */ React.createElement("div", { className: "detail-value" }, renderTextWithLtrNumbers(value)), /* @__PURE__ */ React.createElement("div", { className: `badge sibling-status sibling-status-cell ${siblingStatusData[label]?.className || ""}` }, siblingStatusData[label]?.text || ""))))) : null))), /* @__PURE__ */ React.createElement("div", { className: "card section-anchor", id: "lifestyle-section" }, /* @__PURE__ */ React.createElement("div", { className: "section-header" }, /* @__PURE__ */ React.createElement("span", { className: "section-icon" }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-seedling", "aria-hidden": "true" })), copy.lifestyle.title), /* @__PURE__ */ React.createElement("div", { className: "card-content" }, /* @__PURE__ */ React.createElement("div", { className: "section-item-list" }, lifestyleData.map(({ label, value, iconClass }, idx) => /* @__PURE__ */ React.createElement("div", { className: "detail-row section-card-item", key: idx }, /* @__PURE__ */ React.createElement("div", { className: "detail-label" }, /* @__PURE__ */ React.createElement("span", { className: "detail-label-icon" }, /* @__PURE__ */ React.createElement("i", { className: iconClass, "aria-hidden": "true" })), /* @__PURE__ */ React.createElement("span", null, renderTextWithLtrNumbers(label))), /* @__PURE__ */ React.createElement("div", { className: "detail-value" }, renderTextWithLtrNumbers(value))))))), /* @__PURE__ */ React.createElement("div", { className: "card section-anchor", id: "language-section" }, /* @__PURE__ */ React.createElement("div", { className: "section-header" }, /* @__PURE__ */ React.createElement("span", { className: "section-icon" }, iconLanguage), copy.languages.title), /* @__PURE__ */ React.createElement("div", { className: "card-content" }, /* @__PURE__ */ React.createElement("div", { className: "section-item-list" }, languageData.map(({ title, level, percent }, idx) => /* @__PURE__ */ React.createElement("div", { className: "detail-row language-row section-card-item", key: idx }, /* @__PURE__ */ React.createElement("div", { className: "language-header" }, /* @__PURE__ */ React.createElement("div", { className: "language-title-wrap" }, /* @__PURE__ */ React.createElement("span", { className: "language-title-icon" }, /* @__PURE__ */ React.createElement("i", { className: languageDetailIconClass, "aria-hidden": "true" })), /* @__PURE__ */ React.createElement("div", { className: "language-title" }, renderTextWithLtrNumbers(title))), /* @__PURE__ */ React.createElement("span", { className: "badge language-level-badge" }, renderTextWithLtrNumbers(level))), /* @__PURE__ */ React.createElement(
      "div",
      {
    ...
    }))))))), /* @__PURE__ */ React.createElement("div", { className: "card section-anchor", id: "hobbies-section" }, /* @__PURE__ */ React.createElement("div", { className: "section-header" }, /* @__PURE__ */ React.createElement("span", { className: "section-icon" }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-heart", "aria-hidden": "true" })), copy.hobbies.title), /* @__PURE__ */ React.createElement("div", { className: "card-content" }, /* @__PURE__ */ React.createElement("div", { className: "hobby-list" }, hobbiesData.map(([iconClass, text], idx) => /* @__PURE__ */ React.createElement("div", { className: "hobby-item section-card-item", key: idx }, /* @__PURE__ */ React.createElement("span", { className: "hobby-icon" }, /* @__PURE__ */ React.createElement("i", { className: iconClass, "aria-hidden": "true" })), /* @__PURE__ */ React.createElement("div", { className: "hobby-text" }, renderTextWithLtrNumbers(text))))))), /* @__PURE__ */ React.createElement("div", { className: "card section-anchor", id: "expectation-section" }, /* @__PURE__ */ React.createElement("div", { className: "section-header" }, /* @__PURE__ */ React.createElement("span", { className: "section-icon" }, /* @__PURE__ */ React.createElement("i", { className: "fas fa-heart-circle-check", "aria-hidden": "true" })), copy.expectation.title), /* @__PURE__ */ React.createElement("div", { className: "card-content" }, /* @__PURE__ */ React.createElement("div", { className: "expectation-list" }, expectationItems.map(({ iconClass, title, text }) => /* @__PURE__ */ React.createElement("div", { className: "expectation-item section-card-item", key: title }, /* @__PURE__ */ React.createElement("span", { className: "expectation-item-icon" }, /* @__PURE__ */ React.createElement("i", { className: iconClass, "aria-hidden": "true" })), /* @__PURE__ */ React.createElement("div", { className: "expectation-item-content" }, /* @__PURE__ */ React.createElement("div", { className: "expectation-item-title" }, renderTextWithLtrNumbers(title)), /* @__PURE__ */ React.createElement("div", { className: "expectation-item-text" }, renderTextWithLtrNumbers(text)))))))), /* @__PURE__ */ React.createElement("div", { className: "card section-anchor", id: "contact-section" }, /* @__PURE__ */ React.createElement("div", { className: "section-header" }, /* @__PURE__ */ React.createElement("span", { className: "section-icon" }, iconMapPin), copy.contact.title), /* @__PURE__ */ React.createElement("div", { className: "card-content" }, /* @__PURE__ */ React.createElement("div", { className: "contact-list" }, contactBlocks.map(({ iconClass, label, value, href, mapHref }, idx) => /* @__PURE__ */ React.createElement("div", { className: "contact-block section-card-item", key: `${label}-${value}` }, /* @__PURE__ */ React.createElement("div", { className: "icon-text" }, /* @__PURE__ */ React.createElement("span", { className: "contact-title-icon" }, /* @__PURE__ */ React.createElement("i", { className: iconClass, "aria-hidden": "true" })), /* @__PURE__ */ React.createElement("span", null, renderTextWithLtrNumbers(label))), /* @__PURE__ */ React.createElement("div", { className: "address-box" }, href ? /* @__PURE__ */ React.createElement("a", { className: "contact-action-link", href, target: href.startsWith("http") ? "_blank" : void 0, rel: href.startsWith("http") ? "noreferrer" : void 0 }, renderTextWithLtrNumbers(value)) : renderTextWithLtrNumbers(value)), mapHref ? /* @__PURE__ */ React.createElement("div", { className: "address-actions" }, /* @__PURE__ */ React.createElement(
      "a",
      {
